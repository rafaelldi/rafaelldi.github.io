...
# Client
It’s time to build a client. I used the same worker template as in the [previous post](2019-11-25-rest-api-with-asp-net-core.md). To continue with, I added some nuget libraries and proto file to the client project.
